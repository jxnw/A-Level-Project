...
class InfoPage(Window):
    ...
    def __init__(self, master):
        ...
        img1 = ImageTk.PhotoImage(Image.open("D:\Program_Files\PyCharmProjects\ComputingProject\period.png"))
        ...
        # draw the map
        img2 = ImageTk.PhotoImage(Image.open("D:\Program_Files\PyCharmProjects\ComputingProject\map.jpg"))
